...
//$pageTimerStartTime;
//$pageTimerStopTime;
//$pageTimerStartTime = microtime(true);
...
if(!$auth->isAuthorized())
{
	...
	echo "<label><input type='checkbox' class=chk name='remember' value='yes' checked='checked'/> ".$lang['remember']."</label><br/><br/>";
...
echo "<div id='main' style=font-size:2vh;>";
		...
		case "table_create":
			...
			else
			{
				...
				for($i=0; $i<$num; $i++)
				{
					...
					echo "<tr>";
					echo $tdWithClass;
					echo "<input class=chk type='text' name='".$i."_field' style='width:200px;'/>";
					echo "</td>";
					echo $tdWithClass;
					...
					echo "</td>";
					echo $tdWithClass;
					echo "<label><input type='checkbox' class=chk name='".$i."_primarykey' id='i".$i."_primarykey' onclick='toggleNull(".$i."); toggleAutoincrement(".$i.");'/> ".$lang['yes']."</label>";
					echo "</td>";
					if($db->getType() != "SQLiteDatabase")
					{
						echo $tdWithClass;
						echo "<label><input type='checkbox' class=chk name='".$i."_autoincrement' id='i".$i."_autoincrement'/> ".$lang['yes']."</label>";
						echo "</td>";
					}
					echo $tdWithClass;
					echo "<label><input type='checkbox' class=chk name='".$i."_notnull' id='i".$i."_notnull'/> ".$lang['yes']."</label>";
					echo "</td>";
					echo $tdWithClass;
...
//								printf($lang['query_time'], $queryTimer);
		...
		case "table_empty":
			...
			echo "<input type='checkbox' class=chk name='vacuum' checked='checked'/> ".$lang['vac_on_empty']."<br/><br/>";
		...
		case "table_export":
			...
			echo "<label><input type='checkbox' class=chk checked='checked' name='structure'/> ".$lang['export_struct']."</label> ".helpLink($lang['help5'])."<br/>";
			echo "<label><input type='checkbox' class=chk checked='checked' name='data'/> ".$lang['export_data']."</label> ".helpLink($lang['help6'])."<br/>";
			echo "<label><input type='checkbox' class=chk name='drop'/> ".$lang['add_drop']."</label> ".helpLink($lang['help7'])."<br/>";
			echo "<label><input type='checkbox' class=chk checked='checked' name='transaction'/> ".$lang['add_transact']."</label> ".helpLink($lang['help8'])."<br/>";
			echo "<label><input type='checkbox' class=chk checked='checked' name='comments'/> ".$lang['comments']."</label> ".helpLink($lang['help9'])."<br/>";
			echo "</fieldset>";
			...
			echo "<div style='clear:both;'></div>";
			echo "<label><input type='checkbox' class=chk name='export_csv_crlf'/> ".$lang['rem_crlf']."</label><br/>";
			echo "<label><input type='checkbox' class=chk checked='checked' name='export_csv_fieldnames'/> ".$lang['put_fld']."</label>";
			echo "</fieldset>";
		...
		case "table_import":
			...
			echo "<div style='clear:both;'>";
			echo "<label><input type='checkbox' class=chk checked='checked' name='import_csv_fieldnames'/> ".$lang['fld_names']."</label>";
			echo "</fieldset>";
...
//				printf($lang['query_time'], $queryTimer);
				...
				if(!isset($_SESSION[COOKIENAME.'viewtype']) || $_SESSION[COOKIENAME.'viewtype']=="table")
				{
					...
					for($i=0; $row = $db->fetch($table_result, 'num'); $i++)
					{
						...
						{
							echo $tdWithClass;
							echo "<input type='checkbox' class=chk name='check[]' value='".htmlencode($pk)."' id='check_".htmlencode($i)."'/>";
							echo "</td>";
							echo $tdWithClass;
		...
		case "row_create":
			...
			{
				if($j>0)
					echo "<label><input type='checkbox' class=chk value='ignore' name='".$j.":ignore' id='row_".$j."_ignore' checked='checked'/> ".$lang['ignore']."</label><br/>";
				echo "<table border='0' cellpadding='2' cellspacing='1' class='viewTable'>";
				echo "<tr>";
				echo "<td class='tdheader'>".$lang['fld']."</td>";
				echo "<td class='tdheader'>".$lang['type']."</td>";
				...
				for($i=0; $i<sizeof($tableInfo); $i++)
				{
					...
					{
						if($value===NULL)
							echo "<input type='checkbox' class=chk name='".$i."_null[]' id='row_".$j."_field_".$i."_null' checked='checked' onclick='disableText(this, \"row_".$j."_field_".$i."_value\");'/>";
						else
							echo "<input type='checkbox' class=chk name='".$i."_null[]' id='row_".$j."_field_".$i."_null' onclick='disableText(this, \"row_".$j."_field_".$i."_value\");'/>";
					}
					echo "</td>";
					echo $tdWithClassLeft;
				...
				echo "<tr>";
				echo "<td class='tdheader' style='text-align:left;' colspan='5'>";
	...
	//- Column actions
		...
		case "column_view":
			...
			for($i=0; $i<sizeof($tableInfo); $i++)
			{
				...
				{
					echo $tdWithClass;
					echo "<input type='checkbox' class=chk name='check[]' value='".htmlencode($fieldVal)."' id='check_".$i."'/>";
					echo "</td>";
					echo $tdWithClass;
		...
		case "column_create":
			...
			else
			{
				...
				for($i=0; $i<$num; $i++)
				{
					...
					echo "</td>";
					echo $tdWithClass;
					echo "<label><input type='checkbox' class=chk name='".$i."_primarykey'/> ".$lang['yes']."</label>";
					echo "</td>";
					if($db->getType() != "SQLiteDatabase")
					{
						echo $tdWithClass;
					...
					echo $tdWithClass;
					echo "<label><input type='checkbox' class=chk name='".$i."_notnull'/> ".$lang['yes']."</label>";
					echo "</td>";
					echo $tdWithClass;
					echo "<select name='".$i."_defaultoption' id='i".$i."_defaultoption' onchange=\"if(this.value!='defined' && this.value!='expr') document.getElementById('i".$i."_defaultvalue').value='';\">";
					echo "<option value='none'>".$lang['none']."</option><option value='defined'>".$lang['as_defined'].":</option><option>NULL</option><option>CURRENT_TIME</option><option>CURRENT_DATE</option><option>CURRENT_TIMESTAMP</option><option value='expr'>".$lang['expression'].":</option>";
		...
		case "column_edit":
			...
			else
			{
				...
				else
				{
					...
					echo $tdWithClass;
					if($primarykeyVal)
						echo "<input type='checkbox' class=chk name='".$i."_primarykey' checked='checked'/> Yes";
					else
						echo "<input type='checkbox' class=chk name='".$i."_primarykey'/> Yes";
					echo "</td>";
					echo $tdWithClass;
					if(1==2)
						echo "<input type='checkbox' class=chk name='".$i."_autoincrement' id='".$i."_autoincrement' checked='checked'/> Yes";
					else
						echo "<input type='checkbox' class=chk name='".$i."_autoincrement' id='".$i."_autoincrement'/> Yes";
					echo "</td>";
					echo $tdWithClass;
					if($notnullVal)
						echo "<input type='checkbox' class=chk name='".$i."_notnull' checked='checked'/> Yes";
					else
						echo "<input type='checkbox' class=chk name='".$i."_notnull'/> Yes";
					echo "</td>";
					echo $tdWithClass;
		...
		case "trigger_create":
			...
			else
			{
				...
				echo "<label><input type='checkbox' class=chk name='foreachrow'/> ".$lang['each_row']."</label><br/><br/>";
...
//		echo $lang['db_name'].htmlencode($db->getName())."<br/>";
		echo sprintf($lang['backup_hint'],
			$params->getLink(array('download'=>$currentDB['path'], 'token'=>$_SESSION[COOKIENAME.'token']), $lang["backup_hint_linktext"], '', $lang['backup'])
			);
		echo '<br>';
		echo $lang['db_path'].": <b>".htmlencode($db->getPath())."</b><br/>";
		echo $lang['db_size'].": <b>".number_format($db->getSize ())."MB</b><br/>";
		echo $lang['db_mod'].": <b>".$db->getDate()."</b><br/></div>";
		
//		echo $lang['sqlite_v'].$db->getSQLiteVersion()."<br/>";
//		echo $lang['sqlite_ext']."</b> ".helpLink($lang['help1']).": ".$db->getType()."<br/>";
//		echo $lang['php_v']."</b>: ".phpversion()."<br/>";
//		echo PROJECT." ".$lang["ver"]."</b>: ".VERSION;
...
//	}
	...
	{
		return round(intdiv(filesize($this->data["path"]), 1024*1024) +0.5);
	}
	...
	public function numRows($table, $dontTakeLong = false)
	{
		...
		if(!$dontTakeLong || $this->getSizeKB () <= 2000 || $this->hasPrimaryKey($table))
		{
